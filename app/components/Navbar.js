...
export default function Navbar(){
  ...
  <div className="flex space-x-4">
    ...
    <a href="#" className="text-black hover:text-gray-700">Features</a>
    <a href="#" className="text-black hover:text-gray-700">Contributors</a>
    <a href="#" className="text-black hover:text-gray-700">Report an issue</a>
  </div>
  <div> 
